        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:p-8">
                <div class="flex justify-center">
                    <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto text-gray-700 sm:h-20">
...
<?php /**PATH C:\Users\Lenovo\Documents\Semester 2\Backend Programming (Node JS)\Pertemuan 11\Pertemuan11\resources\views/about.blade.php ENDPATH**/ ?>